package fr.inti.formation.ws.client;
...
public class ConversionServiceClient {
	...
	private static String getOutputAsXML(WebResource subService) {
		return subService.accept(MediaType.TEXT_XML).get(ClientResponse.class).toString();
	}
